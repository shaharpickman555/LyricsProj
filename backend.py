...
whisper_model_frameworks = {
                    'faster':
                    {
                        None: (default_model_name, 'faster', {}, dict(vad_filter=True, vad_parameters=faster_whisper.vad.VadOptions(threshold=0.1, max_speech_duration_s=0.5))),
                        'he': (heb_model_name, 'faster', {}, dict(patience=2, beam_size=5, vad_filter=True, vad_parameters=faster_whisper.vad.VadOptions(threshold=0.1, max_speech_duration_s=0.5))),
                    },
                    'whisperx':
                    {
